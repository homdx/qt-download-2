...
make -j4 --no-print-directory && echo end build && date && echo build done && make install && cd /Qt/5.13.1/Src/qtbase/src/tools/androiddeployqt && make && make install && rm -rf /Qt || echo error build
